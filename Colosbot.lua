...
pcall(function()
	...
	if game.PlaceId == 99995671928896 then
		...
		_G.Botting = function()
			...
			local killtime = tick()
			repeat
				if game.Players.LocalPlayer.Character:FindFirstChild"HumanoidRootPart" and Drogar:FindFirstChild"HumanoidRootPart" and (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(1005.5820922851562, -238.3594970703125, 1517.7528076171875)).magnitude < 200 then
					if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - Vector3.new(1005.5820922851562, -238.3594970703125, 1517.7528076171875)).magnitude < 200 then
